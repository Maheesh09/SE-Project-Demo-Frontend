...
const CompleteProfilePage = () => {
    ...
    return (
        <div
            ...
            style={{
                /* multi-tone gradient base matching the reference screenshot */
                background: "linear-gradient(135deg, #b8ddd0 0%, #d4ecb0 20%, #e8f0c0 40%, #f0e0d8 60%, #e0d0f0 80%, #c8e8e0 100%)"
            }}
        >
            {/* ── Full-page blurred bokeh background ── */}
            {/* Wrapper gets a heavy CSS filter so the ENTIRE background is uniformly blurred */}
            ...
            {/* Subtle brightness layer so the glass card pops */}
            ...
            >
                {/* Avatar circle — sits above the card, sage green to match dashboard */}
