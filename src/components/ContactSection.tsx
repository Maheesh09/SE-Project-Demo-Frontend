...
const ContactSection = () => {
  ...
  return (
    <footer id="contact" className="bg-card/50 border-t border-border/40">
            ...
            <div className="bg-[#acd663]/5 border border-[#acd663]/15 rounded-xl p-4">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 px-3 py-2 rounded-lg border border-border/50 bg-background/80 text-sm placeholder:text-foreground/30 focus:outline-none focus:border-[#acd663]/40 transition-colors"
                />
                <button
                  type="submit"
